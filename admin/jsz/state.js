...
$(function() {
  ...
  for (var i = 0; i < handles.length; i++) {
      ...
      options += '<option value="' + Ids + '">' + handles[i] + '</option>';
  }
...
function selct_district($val)
{
 ...
 if($val=='Andhra Pradesh') {
   var andhra = ["Select City","Anantapur","Chittoor","East Godavari","Guntur","Krishna","Kurnool","Prakasam","Srikakulam","SriPotti Sri Ramulu Nellore",
  ...
  if ($val=='Arunachal Pradesh') {
    var ap = ["Select City","Anjaw","Changlang","Dibang Valley","East Siang","East Kameng","Kurung Kumey","Lohit","Longding","Lower Dibang Valley","Lower Subansiri","Papum Pare",
  ...
  if ($val=='Assam') {
    var assam = ["Select City","Baksa","Barpeta","Bongaigaon","Cachar","Chirang","Darrang","Dhemaji","Dima Hasao","Dhubri","Dibrugarh","Goalpara","Golaghat","Hailakandi","Jorhat",
  ...
  if ($val=='Bihar') {
    var bihar = ["Select City","Araria","Arwal","Aurangabad","Banka","Begusarai","Bhagalpur","Bhojpur","Buxar","Darbhanga","East Champaran","Gaya","Gopalganj","Jamui","Jehanabad","Kaimur",
  ...
  if ($val=='Chhattisgarh') {
    var Chhattisgarh = ["Select City","Bastar","Bijapur","Bilaspur","Dantewada","Dhamtari","Durg","Jashpur","Janjgir-Champa","Korba","Koriya","Kanker","Kabirdham (formerly Kawardha)","Mahasamund",
  ...
  if ($val=='Delhi') {
    var delhi = ["Select City","Delhi","New Delhi","North Delhi","Noida","Patparganj","Sonabarsa","Tughlakabad"];
   $(function() {
  var options = '';
  ...
  if ($val=='Goa') {
    var goa = ["Select City","Chapora","Dabolim","Madgaon","Marmugao (Marmagao)","Panaji Port","Panjim","Pellet Plant Jetty/Shiroda","Talpona","Vasco da Gama"];
   $(function() {
  var options = '';
  ...
  if ($val=='Gujarat') {
    var gujarat = ["Select City","Ahmedabad","Amreli district","Anand","Aravalli","Banaskantha","Bharuch","Bhavnagar","Dahod","Dang","Gandhinagar","Jamnagar","Junagadh",
  ...
  if ($val=='Haryana') {
    var haryana = ["Select City","Ambala","Bhiwani","Faridabad","Fatehabad","Gurgaon","Hissar","Jhajjar","Jind","Karnal","Kaithal",
  ...
  if ($val=='Himachal Pradesh') {
    var himachal = ["Select City","Baddi","Baitalpur","Chamba","Dharamsala","Hamirpur","Kangra","Kinnaur","Kullu","Lahaul & Spiti","Mandi","Simla","Sirmaur","Solan","Una"];
   $(function() {
  var options = '';
  ...
  if ($val=='Jammu and Kashmir') {
    var jammu = ["Select City","Jammu","Leh","Rajouri","Srinagar"];
   $(function() {
  var options = '';
  ...
  if ($val=='Jharkhand') {
    var jharkhand = ["Select City","Bokaro","Chatra","Deoghar","Dhanbad","Dumka","East Singhbhum","Garhwa","Giridih","Godda","Gumla","Hazaribag","Jamtara","Khunti","Koderma","Latehar","Lohardaga","Pakur","Palamu",
  ...
  if ($val=='Karnataka') {
    var karnataka = ["Select City","Bagalkot","Bangalore","Bangalore Urban","Belgaum","Bellary","Bidar","Bijapur","Chamarajnagar", "Chikkamagaluru","Chikkaballapur",
  ...
  if ($val=='Kerala') {
    var kerala = ["Select City","Alappuzha","Ernakulam","Idukki","Kannur","Kasaragod","Kollam","Kottayam","Kozhikode","Malappuram","Palakkad","Pathanamthitta","Thrissur","Thiruvananthapuram","Wayanad"];
   $(function() {
  var options = '';
  ...
  if ($val=='Madhya Pradesh') {
    var mp = ["Select City","Alirajpur","Anuppur","Ashoknagar","Balaghat","Barwani","Betul","Bhilai","Bhind","Bhopal","Burhanpur","Chhatarpur","Chhindwara","Damoh","Dewas","Dhar","Guna","Gwalior","Hoshangabad",
  ...
  if ($val=='Maharashtra') {
    var maharashtra = ["Select City","Ahmednagar","Akola","Alibag","Amaravati","Arnala","Aurangabad","Aurangabad","Bandra","Bassain","Belapur","Bhiwandi","Bhusaval","Borliai-Mandla","Chandrapur","Dahanu","Daulatabad","Dighi (Pune)","Dombivali","Goa","Jaitapur","Jalgaon",
  ...
  $('#secondlist').html(options);
   ...
   if ($val=='Manipur') {
    var manipur = ["Select City","Bishnupur","Churachandpur","Chandel","Imphal East","Senapati","Tamenglong","Thoubal","Ukhrul","Imphal West"];
   $(function() {
  var options = '';
  ...
  $('#secondlist').html(options);
   ...
   if ($val=='Meghalaya') {
    var meghalaya = ["Select City","Baghamara","Balet","Barsora","Bolanganj","Dalu","Dawki","Ghasuapara","Mahendraganj","Moreh","Ryngku","Shella Bazar","Shillong"];
   $(function() {
  var options = '';
  ...
  $('#secondlist').html(options);
   ...
   if ($val=='Mizoram') {
    var mizoram = ["Select City","Aizawl","Champhai","Kolasib","Lawngtlai","Lunglei","Mamit","Saiha","Serchhip"];
   $(function() {
  var options = '';
  ...
  if ($val=='Orissa') {
    var orissa = ["Select City","Bahabal Pur","Bhubaneswar","Chandbali","Gopalpur","Jeypore","Paradip Garh","Puri","Rourkela"];
   $(function() {
  var options = '';
  ...
  if ($val=='Puducherry') {
    var puducherry = ["Select City","Karaikal","Mahe","Pondicherry","Yanam"];
   $(function() {
  var options = '';
  ...
  if ($val=='Punjab') {
    var punjab = ["Select City","Amritsar","Barnala","Bathinda","Firozpur","Faridkot","Fatehgarh Sahib","Fazilka","Gurdaspur","Hoshiarpur","Jalandhar","Kapurthala","Ludhiana","Mansa","Moga","Sri Muktsar Sahib","Pathankot",
  ...
  if ($val=='Rajasthan') {
    var rajasthan = ["Select City","Ajmer","Banswara","Barmer","Barmer Rail Station","Basni","Beawar","Bharatpur","Bhilwara","Bhiwadi","Bikaner","Bongaigaon","Boranada, Jodhpur","Chittaurgarh","Fazilka","Ganganagar","Jaipur","Jaipur-Kanakpura",
  ...
  if ($val=='Tamil Nadu') {
    var tn = ["Select City","Ariyalur","Chennai","Coimbatore","Cuddalore","Dharmapuri","Dindigul","Erode","Kanchipuram","Kanyakumari","Karur","Krishnagiri","Madurai","Mandapam","Nagapattinam","Nilgiris","Namakkal","Perambalur","Pudukkottai","Ramanathapuram","Salem","Sivaganga","Thanjavur","Thiruvallur","Tirupur",
  ...
  if ($val=='Telangana') {
    var telangana = ["Select City","Adilabad","Hyderabad","Karimnagar","Mahbubnagar","Medak","Nalgonda","Nizamabad","Ranga Reddy","Warangal"];
   $(function() {
  var options = '';
  ...
  if ($val=='Tripura') {
    var tripura = ["Select City","Agartala","Dhalaighat","Kailashahar","Kamalpur","Kanchanpur","Kel Sahar Subdivision","Khowai","Khowaighat","Mahurighat","Old Raghna Bazar","Sabroom","Srimantapur"];
   $(function() {
  var options = '';
  ...
  if ($val=='Uttar Pradesh') {
    var up = ["Select City","Agra","Allahabad","Auraiya","Banbasa","Bareilly","Berhni","Bhadohi","Dadri","Dharchula","Gandhar","Gauriphanta","Ghaziabad","Gorakhpur","Gunji",
  ...
  if ($val=='Uttarakhand') {
    var uttarakhand = ["Select City","Almora","Badrinath","Bangla","Barkot","Bazpur","Chamoli","Chopra","Dehra Dun","Dwarahat","Garhwal","Haldwani","Hardwar","Haridwar","Jamal","Jwalapur","Kalsi","Kashipur","Mall",
  ...
  if ($val=='West Bengal') {
    var wb = ["Select City","Alipurduar","Bankura","Bardhaman","Birbhum","Cooch Behar","Dakshin Dinajpur","Darjeeling","Hooghly","Howrah",
