...
<head>
    ...
    if(isset($_POST['register']))
    {
		...
		if($Password==$confPassword)
		{
			...
			$sql = "INSERT INTO `nonapstm`(`name`, `Gender`, `Professional`, `mobileno`, `email`, `Password`, `address`,`state`, `city`, `referenceNameone`, `referenceMobileone`, `referenceNametwo`, `referenceMobiletwo`,`active`, `isRegistered`) VALUES ('$txtname','$Gender','$Professional','$mobileno','$email','$Password','$address','$state','$city','$referenceNameone','$referenceMobileone','$referenceNametwo','$referenceMobiletwo',0,1)";
			...
			{
				echo "<script>window.location.assign('thanks.php?nonapstm');</script>";
			}
		}
		else
		{
        ...
        <form id="registration" name="registration" method="post">
            ...
            <section class="clearfix innerData">
                <div class="container">
                   ...
                   <div class="w33">
                        <div class="item">
                            <input type="text" name="firstname" id="firstname" placeholder="First Name" maxlength= "15" onkeypress = "isNOTNumberKey(evt);" />
                        </div>
                    </div>
                    <div class="w33">
                        <div class="item">
                            <input type="text" name="middlename" placeholder="Middle Name" id="middlename" maxlength= "15" />
                        </div>
                    </div>
                     <div class="w33">
                        <div class="item">
                            <input type="text" name="lastname" placeholder="Last Name" id="lastname" maxlength= "15" />
                        </div>
                    </div>
                </div>-->
                        <div class="item">
